...
data=pd.read_csv('sem_recog12896.csv')
# print(data.info())
# print(df.head())
data.shape
...
X_train, X_test, train_y, test_y = train_test_split(X, y, test_size=0.1, random_state=42)
...
labelNames = ['Porous Sponge','Patterned surface','Particles','Films Coated Surface','Powder', 'Tips','Nanowires', 'Biological','MEMS Devices and Electrodes','Fibres']
...
X_train = X_train.reshape(X_train.shape[0], 96, 128, 1)
